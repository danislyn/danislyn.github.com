...
- 引入 [phantomJS](/blog/2014/06/12/use-phantomjs-to-capture-webpage) 来做网页截图，警示页面恶意篡改
...
- 在开发过程中还记录了一些遇到的问题，[nodejs爬虫实现中遇到的坑](/blog/2016/03/27/blackholes-in-node-crawler) 后续会慢慢整理补充
